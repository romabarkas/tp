					...
					<thead class="thead-dark">
						...
						<tr>
							...
							<td>
								...
								<a href="?pizza.php=<?=$value['id'] ?>" class="btn btn-danger btn-sm" data-target="#pizza<?=$value['id'] ?>"><i class="fa fa-check-square"></i></a>
								<a href="?number=<?=$value['id'] ?>" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#numberModal<?=$value['id'] ?>"><i class="fa fa-balance-scale"></i></a>
